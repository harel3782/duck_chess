...
def analyze_replay(filepath):
	...
	for i, action in enumerate(actions):
		...
		start_sq = action // 64 #23
		end_sq = action % 64 #13
		
		sr, sc = start_sq // 8, start_sq % 8 #2, 7
		er, ec = end_sq // 8, end_sq % 8 #1, 5
		...
		print(f"Action {i}: {action} -> Start: {start_str}, End: {end_str}")
...
analyze_replay("periodic_ep10_1777634889_7c5bc6.pkl")
