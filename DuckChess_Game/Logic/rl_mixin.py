...
class RLMixin:
	"""
	Machine Learning and Reinforcement Learning Adapters.
	Handles the generation of observation tensors and action masks for the AI agent.
	"""
	...
	def debug_print_observation(self):
		...
		"""
		# --- ADD THIS CHECK ---
		# Prevent printing during fast replay reconstruction or RL training
		if getattr(self, 'game_mode', '') in ['rl_training', 'replay']:
			return
		# ----------------------
